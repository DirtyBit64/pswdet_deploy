...
# path = r"D:\CV\PSWDET_SOURCE\PSW_TESTSET\psw_clear"
...
results = model.predict(source=path, conf=0.6, imgsz=1280, stream=True, device=[0], save=False,
                        seg_filter=True, save_if_box_father=False)
