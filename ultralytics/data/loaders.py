...
class LoadStreams:
    """YOLOv8 streamloader, i.e. `yolo yolospp_fake source='rtsp://example.com/media.mp4'  # RTSP, RTMP, HTTP streams`."""
...
class LoadScreenshots:
    """YOLOv8 screenshot dataloader, i.e. `yolo yolospp_fake source=screen`."""
...
class LoadImages:
    """YOLOv8 image/video dataloader, i.e. `yolo yolospp_fake source=image.jpg/vid.mp4`."""
