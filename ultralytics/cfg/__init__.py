...
MODES = 'train', 'val', 'yolospp_fake', 'export', 'track', 'benchmark'
...
CLI_HELP_MSG = \
    ...
    2. Predict a YouTube video using a pretrained segmentation model at image size 320:
        yolo yolospp_fake model=yolov8n-seg.pt source='https://youtu.be/Zgi9g1ksQHc' imgsz=320
...
def entrypoint(debug=''):
    ...
    - specifying the mode, either 'train', 'val', 'test', or 'yolospp_fake'
    ...
    if mode is None:
        mode = DEFAULT_CFG.mode or 'yolospp_fake'
    ...
    # Mode
    if mode in ('yolospp_fake', 'track') and 'source' not in overrides:
...
if __name__ == '__main__':
    # Example: entrypoint(debug='yolo yolospp_fake model=yolov8n.pt')
    entrypoint(debug='')
